...
equal(context.setupState(false, false, "", "2.1.0"), "checking", "unchecked setup state")
equal(context.setupState(true, false, "", "2.1.0"), "missing", "missing helper needs setup")
equal(context.setupState(true, true, "2.0.6", "2.1.0"), "update", "old helper needs update")
equal(context.setupState(true, true, "", "2.1.0"), "update", "broken helper needs update")
equal(context.setupState(true, true, "2.1.0", "2.1.0"), "ready", "matching helper is ready")
