...
equal(context.setupState(false, false, "", "2.0.3"), "checking", "unchecked setup state")
equal(context.setupState(true, false, "", "2.0.3"), "missing", "missing helper needs setup")
equal(context.setupState(true, true, "2.0.2", "2.0.3"), "update", "old helper needs update")
equal(context.setupState(true, true, "", "2.0.3"), "update", "broken helper needs update")
equal(context.setupState(true, true, "2.0.3", "2.0.3"), "ready", "matching helper is ready")
